    ...
    <div class="homeWrapper">
        <div class="homeWrapper--profile">
            ...
            <div class="homeWrapper--profile__content">
                <h2>Fahmi Irsyad Khairi</h2>
                <span class="usernameProfile">@pampam</span>
                <div class="bioProfile">
                    <p><q>professional producer , also can design UI/UX.</q></p>
                </div>
                <div class="socialProfile">
                    <p class="socialProfile__facebook"><a href="">Facebook</a></p>
                    |
                    <p class="socialProfile__instagram"><a href="">Instagram</a></p>
                </div>
                <div class="editProfileWrapper">
                        <a href="" class="button--editProfile">Edit profile</a>
                </div>
            </div>
